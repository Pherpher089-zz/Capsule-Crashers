...
public class EnemyAI : MonoBehaviour {
    ...
    BaseWall targetwall;                                    //The object of which an attack possition is occupied
    ...
    /// <summary>
    /// checks for players that are in the trigger. If there is a player, a raycast is executed to check line of sight.
    /// </summary>
    ...
    /// <summary>
    /// Checks for collision with the player. If true, the player takes damage.
    /// </summary>
